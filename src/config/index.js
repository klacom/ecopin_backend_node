...
export const SPATIAL_FORECAST_SERVICE_URL = process.env.SPATIAL_FORECAST_SERVICE_URL || 'http://127.0.0.1:8001';
...
export const REPORT_VIDEO_FILE_SIZE = 50 * 1024 * 1024; // 50MB for videos
...
export const VALID_VIDEO_MIME_TYPES = ['video/mp4', 'video/quicktime', 'video/webm'];
export const VALID_VIDEO_EXTENSIONS = ['mp4', 'mov', 'webm'];
